...
public:
	...
	char m_normal_map_name[NAME_STR_SIZE];
	CVector2D m_st;
...
struct CCollTriangle {
	...
	CCollTriangle():m_dist(0), m_material_id(0){}
...
public:
	...
	**/
	...
	@brief	テクスチャ読み込み
	@param	no				[in] マテリアル番号
	@param	tex_name		[in] カラーテクスチャ
	@param	normal_name		[in] 法線テクスチャ
	@retval	マテリアルのポインタ
	**/
